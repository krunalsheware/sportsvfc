...
const ContactUs = () => {
  return (
    <div >
      <Nav />
      <div className="container py-6  grid md:grid-cols-2 gap-8 md:gap-0 md:p-8 my-20 mx-20">
        ...
        <div>
          <li className="cole">
            ...
            <iframe
              ...
              className="map sm:w-700 sm:h-400 md:w-800 md:h-500 lg:w-900 lg:h-600 xl:w-1000 xl:h-700"
            ></iframe>
          </li>
        </div>
      </div>
